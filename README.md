...
- [heraldstack](https://github.com/chasko-labs/heraldstack) — placeholder repo carrying harald's catchphrase *"science bless us everyone"* — the real framework lives in heraldstack-core
